var tinyMCEPreInit = { settings : { themes : "advanced", plugins : "safari,inlinepopups,autosave,spellchecker,paste,wordpress,media,fullscreen,wpeditimage,-NextGEN,directionality", languages : "ar", debug : false }, base : "http://www.omardo.com/blog/wp-includes/js/tinymce", suffix : "", query : "ver=311" };tinyMCEPreInit.start = function() {
...
class_name:"فئة",
not_set:"-- غير معين --",
clipboard_msg:"النسخ/ القطع واللصق غير متوفرة في متصفحا موزيللا وفيرفوكس",
clipboard_no_support:"حالياً غير مدعومة بواسطة متصفحك، استخدم احتصارات لوحة المفاتيح بدلاً عنها",
popup_blocked:"عذراً ! لاحظنا أن مانع الإعلانات منع النافذة من الظهور، يرجى السماح لهذا الموقع بعرض النوافذ (popup) حتى تعمل هذه الأداة بشكل جيد",
invalid_data:"خطأ: تم إدخال قيم غير صالحة، تم تعليمها بالأحمر",
...
date_fmt:"%Y-%m-%d",
time_fmt:"%H:%M:%S",
insertdate_desc:"أدرج التاريخ",
inserttime_desc:"أدرج الوقت",
months_long:"يناير,فبراير,مارس,أبريل,مايو,يونيو,يوليو,أغسطس,سبتمبر,أكتوبر,نوفمبر,ديسمبر",
months_short:"يناير_يناير_abbreviation,فبراير_فبراير_abbreviation,مارس_مارس_abbreviation,أبريل_أبريل_abbreviation,مايو_مايو_abbreviation,يونيو_يونيو_abbreviation,يوليو_يوليو_abbreviation,أغسطس_أغسطس_abbreviation,سبتمبر_سبتمبر_abbreviation,أكتوبر_أكتوبر_abbreviation,نوفمبر_نوفمبر_abbreviation,ديسمبر_ديسمبر_abbreviation",
day_long:"الأحد,الأثنين,الثلاثاء,الأربعاء,الخميس,الجمعة,السبت",
day_short:"أح,اث,ث,أر,خ,ج,س"
},
print:{
print_desc:"طباعة"
},
...
directionality:{
ltr_desc:"الاتجاه من اليسار لليمين",
rtl_desc:"الاتجاه من اليمين لليسار"
},
layer:{
insertlayer_desc:"أدرج طبقة جديدة",
forward_desc:"حرك للأمام",
backward_desc:"عد للخلف",
absolute_desc:"طبق المسار المطلق",
content:"طبقة جديدة..."
},
save:{
save_desc:"حفظ",
cancel_desc:"الغ كل التغييرات"
},
nonbreaking:{
nonbreaking_desc:"أدرج رمز عدم التقسيم"
},
iespell:{
iespell_desc:"شغل المدقق الإملائي",
download:"ieSpell غير موجود، هل تريد تركيبه الآن ؟"
},
advhr:{
advhr_desc:"خط أفقي"
},
emotions:{
emotions_desc:"انفعالات"
},
searchreplace:{
search_desc:"ابحث",
replace_desc:"ابحث/ استبدل"
},
advimage:{
image_desc:"أدرج/ حرر صورة"
},
advlink:{
link_desc:"أدرج/ حرر الرابط"
},
xhtmlxtras:{
cite_desc:"استشهاد",
abbr_desc:"اختصار",
...
del_desc:"حذف",
ins_desc:"إدراج",
attribs_desc:"أدرج/ حرر السمات"
},
style:{
desc:"تحرير طراز CSS"
},
paste:{
paste_text_desc:"ألصق كنص عادي",
paste_word_desc:"ألصق من الوورد",
selectall_desc:"اختر الكل"
},
paste_dlg:{
text_title:"استخدم CTRL+V من لوحة المفاتيح للصق النص في النافذة",
text_linebreaks:"احتفظ بفواصل الأسطر",
word_title:"استخدم CTRL+V من لوحة المفاتيح للصق النص في النافذة"
},
table:{
desc:"أدرج جدول جديد",
row_before_desc:"أدرج سطر قبل",
row_after_desc:"أدرج صف بعد",
delete_row_desc:"احذف صف",
col_before_desc:"أدرج عمود قبل",
col_after_desc:"أضف عمود بعد",
delete_col_desc:"احذف عمود",
split_cells_desc:"قسم خلايا الجدول المدموجة",
merge_cells_desc:"ادمج خلايا الجدول",
row_desc:"خصائص صف الجدول",
cell_desc:"خصائص خلية الجدول",
props_desc:"خصائص الجدول",
paste_row_before_desc:"الصق صف الجدول قبل",
paste_row_after_desc:"الصق صف الجدول بعد",
cut_row_desc:"اقطع صف الجدول",
copy_row_desc:"انسخ صف الجدول",
del:"احذف الجدول",
row:"صف",
col:"عمود",
cell:"خلية"
...
autosave:{
unload_msg:"التغييرات التي أحدثتها ستفقد إذا غادرت هذه الصفحة"
},
fullscreen:{
desc:"طبق أسلوب الشاشة الكاملة (Alt+Shift+G)"
},
media:{
desc:"أدرج / حرر الوسائط المضمنة",
delta_width:"0 ",
delta_height:"0 ",
edit:"حرر الوسائط المضمنة"
},
fullpage:{
desc:"خصائص الملف"
},
template:{
desc:"أدرج محتوى النموذج المعرف مسبقاً"
},
visualchars:{
desc:"أحرف التحكم المرئية تعمل/ لا تعمل"
},
spellchecker:{
desc:"شغل المدقق الإملائي (Alt+Shift+N)",
...
sug:"اقتراحات",
no_sug:"لا اقتراحات",
no_mpell:"لا يوجد أخطاء إملائية"
},
pagebreak:{
desc:"أضف فاصل صفحة"
}}});
...
style_select:"الطرازات",
font_size:"حجم الخط",
fontdefault:"عائلة الخط",
block:"التنسيق",
paragraph:"فقرة",
div:"قسم",
address:"العنوان",
...
dt:"مصطلح تعريفي",
dd:"وصف التعريف",
bold_desc:"عريض (Ctrl / Alt+Shift + B)",
italic_desc:"مائل (Ctrl / Alt+Shift + I)",
underline_desc:"تحته خط",
striketrough_desc:"يتوسطه خط (Alt+Shift+D)",
justifyleft_desc:"محاذاة إلى ليسار (Alt+Shift+L)",
justifycenter_desc:"توسيط (Alt+Shift+C)",
justifyright_desc:"محاذاة إلى اليمين (Alt+Shift+R)",
justifyfull_desc:"محاذاة كاملة (Alt+Shift+J)",
bullist_desc:"قائمة نقطية (Alt+Shift+U)",
numlist_desc:"قائمة رقمية (Alt+Shift+O)",
outdent_desc:"إزالة إقتباس/إنقاص المسافة البادئة",
indent_desc:"إضافة إقتباس/زيادة المسافة البادئة",
undo_desc:"تراجع (Ctrl+Z)",
redo_desc:"إلغاء التراجع (Ctrl+Y)",
link_desc:"أدرج/ حرر الرابط (Alt+Shift+A)",
link_delta_width:"0",
link_delta_height:"0",
unlink_desc:"إزالة الرابط (Alt+Shift+S)",
image_desc:"أدرج/ حرر صورة (Alt+Shift+M)",
image_delta_width:"0",
image_delta_height:"0",
cleanup_desc:"نظف الكود الملخبط",
code_desc:"تحرير مصدر HTML",
sub_desc:"أحرف سفلية",
sup_desc:"أحرف علوية",
hr_desc:"أدرج سطر أفقي",
removeformat_desc:"أزل التنسيق",
forecolor_desc:"اختر لون النص",
backcolor_desc:"اختر لون الخلفية",
charmap_desc:"أدرج حرف مخصص",
visualaid_desc:"طبق الإرشادات/ عناصر غير مرئية",
anchor_desc:"أدرج/ حرر رابط",
cut_desc:"قطع",
copy_desc:"نسخ",
paste_desc:"لصق",
...
help_desc:"مساعدة",
blockquote_desc:"صندوق اقتباس (Alt+Shift+Q)",
clipboard_msg:"النسخ/ القطع واللصق غير متوفرة في متصفحا موزيللا وفيرفوكس",
path:"مسار",
newdocument:"هل أنت متأكد من أنك تريد حذف كل المحتويات؟",
toolbar_focus:"اذهب إلى أداة الأزرار - Alt+Q، اذهب إلى المحرر - Alt-Z، اذهب إلى مسار العنصر- Alt-X",
more_colors:"المزيد من الألوان",
...
about_title:"نبذة عن TinyMCE",
about_general:"سيرة ذاتية",
about_help:"مساعدة",
about_license:"ترخيص",
...
anchor_title:"أدرج/ حرر رابط",
anchor_name:"اسم الرابط",
code_title:"المحرر المصدري ل HTML",
code_wordwrap:"فصل الكلمات (Word wrap)",
colorpicker_title:"اختر لون ",
colorpicker_picker_tab:"الملتقط",
colorpicker_picker_title:"ملتقط اللون",
colorpicker_palette_tab:"لوحة",
colorpicker_palette_title:"لوحة الألوان",
colorpicker_named_tab:"تمت التسمية",
colorpicker_named_title:"الألوان المسماة",
colorpicker_color:"اللون:",
colorpicker_name:"الاسم:",
charmap_title:"اختر الحرف المخصص",
image_title:"أدرج/ حرر صورة",
image_src:"رابط الصورة",
image_alt:"وصف الصورة",
image_list:"قائمة الصورة",
image_border:"حد",
image_dimensions:"أبعاد",
image_vspace:"مسافة عمودية",
image_hspace:"مسافة أفقة",
image_align:"محاذاة",
image_align_baseline:"خط القاعدة",
image_align_top:"أعلى",
image_align_middle:"منتصف",
...
link_title:"أدرج/ حرر الرابط",
link_url:"رابط الوصلة",
link_target:"أين يفتح الرابط:",
link_target_same:"افتح الرابط في نفس النافذة",
link_target_blank:"افتح الرابط في نافذة جديدة",
link_titlefield:"العنوان",
link_is_email:"الرابط الذي أدخلته يبدو وكأنه عنوان إيميل، هل تريد إضافة البادئة mailto: له ؟",
link_is_external:"الرابط الذي أدخلته يبدو وكأنه رابط خارجي، هل تريد إضافة البادئة http:// له ؟",
link_list:"قائمة الروابط"
});

tinyMCE.addI18n("ar.media_dlg",{
title:"أدرج / حرر الوسائط المضمنة",
general:"عام",
advanced:"متقدم",
file:"ملف/ رابط",
list:"قائمة",
size:"أبعاد",
preview:"معاينة",
constrain_proportions:"النسب المقيدة (Constrain proportions)",
type:"النوع",
id:"الهوية",
name:"الاسم",
class_name:"فئة",
...
playeveryframe:"شغل كل إطار",
targetcache:"الذاكرة الهدف (Target cache)",
correction:"لا تصحيح",
enablejavascript:"فعل الجافاسكربت",
starttime:"وقت البدء",
endtime:"وقت الانتهاء",
href:"Href",
qtsrcchokespeed:"سرعة الاختناق",
target:"أين يفتح الرابط:",
volume:"الصوت",
autostart:"بداية أوتوماتيكية",
enabled:"مفعل",
fullscreen:"شاشة كاملة",
invokeurls:"استدعاء الروابط",
mute:"صامت",
stretchtofit:"مدد حتى تتناسب",
windowlessvideo:"فيديو بلا نافذة",
balance:"توازن",
baseurl:"رابط المدونة",
captioningid:"عنونة الهوية (id)",
currentmarker:"العلامة الحالية",
currentposition:"المكان الحالي",
defaultframe:"الإطار الافتراضي",
playcount:"شغل العد",
rate:"التقييم",
uimode:"نمط (UI)",
flash_options:"خيارات الفلاش",
qt_options:"خيارات Quicktime ",
wmp_options:"خصائص Windows media player",
rmp_options:"خيارات Real media player",
shockwave_options:"خيارات Shockwave ",
autogotourl:"اذهب للرابط أوتوماتيكياً",
center:"وسط",
imagestatus:"حالة الصورة",
maintainaspect:"حافظ على الواجهة",
nojava:"لا جافا",
prefetch:"جلب مسبق",
shuffle:"مراوغة (Shuffle)",
console:"Console",
numloop:"عدد الحلقات",
controls:"متحكمات",
scriptcallbacks:"سكربت الاستدعاء",
swstretchstyle:"توسيع النسق",
swstretchhalign:"توسيع المحاذاة الأفقية",
swstretchvalign:"توسيع المحاذاة العمودية",
sound:"صوت",
progress:"عمل",
qtsrc:"QT Src",
...
flv_options:"خصائص الفيديو الفلاشي",
flv_scalemode:"أسلوب النطاق (Scale mode)",
flv_buffer:"الذاكرة",
flv_startimage:"صورة البداية",
flv_starttime:"وقت البدء",
flv_defaultvolume:"الصوت الافتراضي",
flv_hiddengui:"واجهة رسومية مخفية",
flv_autostart:"بداية أوتوماتيكية",
flv_loop:"حلقة",
flv_showscalemodes:"عرض أساليب النطاق (scale modes)",
flv_smoothvideo:"فيديو سلس",
flv_jscallback:"استدعاء ال JS"
});

tinyMCE.addI18n("ar.wordpress",{
wp_adv_desc:"إظهار/إخفاء المزيد من الخيارات (Alt+Shift+Z)",
wp_more_desc:"أضف المزيد من الأوسمة (Alt+Shift+T)",
wp_page_desc:"أدرج فاصل صفحة (Alt+Shift+P)",
wp_help_desc:"مساعدة (Alt+Shift+H)",
wp_more_alt:"المزيد...",
wp_page_alt:"الصفحة التالية...",
add_media:"أضف ميديا",
add_image:"أضف صورة",
add_video:"أضف فيديو",
add_audio:"أضف صوت"
...
tinyMCE.addI18n("ar.wpeditimage",{
edit_img:"تحرير الصورة",
del_img:"حذف الصورة",
adv_settings:"إعدادات متقدمة",
none:"بدون",
size:"حجم",
...
link_to_img:"الربط بصورة",
link_help:"أدخل رابط أو اضغط في الأعلى للتعيين المسبق",
adv_img_settings:"إعدادات الصورة المتقدمة",
source:"المصدر",
width:"عرض",
height:"ارتفاع",
orig_size:"الحجم الأصلي",
css:"CSS Class",
adv_link_settings:"إعدادات الرابط المتقدمة",
link_rel:"خصائص الرابط",
height:"ارتفاع",
orig_size:"الحجم الأصلي",
css:"CSS Class",
s60:"60%",
...
s120:"120%",
s130:"130%",
img_title:"تحرير عنوان الصورة",
caption:"تحرير وصف الصورة",
alt:"تحرير النص البديل"
});
...
tinymce.PluginManager.load("NextGEN", "http://www.omardo.com/blog/wp-content/plugins/nextgen-gallery/tinymce3/editor_plugin.js");
tinyMCE.init({mode:"none",onpageload:"wpEditorInit",width:"100%",theme:"advanced",skin:"wp_theme",theme_advanced_buttons1:"bold,italic,strikethrough,|,bullist,numlist,blockquote,|,justifyleft,justifycenter,justifyright,|,link,unlink,wp_more,|,spellchecker,fullscreen,wp_adv,separator,NextGEN,ltr",theme_advanced_buttons2:"formatselect,underline,justifyfull,forecolor,|,pastetext,pasteword,removeformat,|,media,charmap,|,outdent,indent,|,undo,redo,wp_help",theme_advanced_buttons3:"",theme_advanced_buttons4:"",language:"ar",spellchecker_languages:"+English=en,Danish=da,Dutch=nl,Finnish=fi,French=fr,German=de,Italian=it,Polish=pl,Portuguese=pt,Spanish=es,Swedish=sv",theme_advanced_toolbar_location:"top",theme_advanced_toolbar_align:"left",theme_advanced_statusbar_location:"bottom",theme_advanced_resizing:"1",theme_advanced_resize_horizontal:"",dialog_type:"modal",relative_urls:"",remove_script_host:"",convert_urls:"",apply_source_formatting:"",remove_linebreaks:"1",paste_convert_middot_lists:"1",paste_remove_spans:"1",paste_remove_styles:"1",gecko_spellcheck:"1",entities:"38,amp,60,lt,62,gt",accessibility_focus:"",tab_focus:":next",content_css:"http://www.omardo.com/blog/wp-includes/js/tinymce/wordpress.css",save_callback:"switchEditors.saveCallback",wpeditimage_do_captions:"1",plugins:"safari,inlinepopups,autosave,spellchecker,paste,wordpress,media,fullscreen,wpeditimage,-NextGEN,directionality",directionality:"rtl"});